    ...
    <div className="flex min-h-screen flex-col bg-zinc-950 text-zinc-200">
      ...
      <main className="mx-auto w-full max-w-[1600px] flex-1 px-4 py-4">
        ...
        <section aria-label="Сработавший паттерн">
          ...
          {patterns.length ? (
            ...
            <div className="rounded-xl border border-zinc-800 bg-zinc-900/40 p-4 text-sm text-zinc-600">
              Паттернов сейчас нет: роботы не давят неликвид, либо спреды спокойны. Таблица ниже показывает алго-активность
              и неликвидность всех монет — паттерн сработает, когда всё совпадёт (алго ≥55 · неликвид ≥50 · спред).
            </div>
          )}
        </section>
        ...
        <section className="mt-6 rounded-xl border border-zinc-800 bg-zinc-900/40 p-4 text-xs leading-relaxed text-zinc-500">
          ...
          Паттерн «робот вошёл» = алго ≥55 + неликвид ≥50 + нетто-спред ≥0.15% (или кросс ≥0.3%): робот продавливает
          тонкий рынок, соседняя биржа не успевает — это и есть окно неэффективности.
        </section>
      </main>
