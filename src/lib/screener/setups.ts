...
/* Дальше этого расстояния до уровня сигнал не выдаётся. Порог измеренный, не выбранный:
   на 50 разрешённых исходах сигналы дальше 0.5 ATR дали матожидание −0.284% с
   доверительным интервалом целиком ниже нуля, в пределах 0.5 ATR — +0.007%.
   Сжатие без близости к границе означает, что двигаться ещё некуда. */
export const BREAKOUT_MAX_DIST_ATR = 0.5;
